...
export class HealthCheckApi {
     ...
     */
    public async healthcheck (options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: HealthCheckResponse;  }> {
        const localVarPath = this.basePath + '/v6/healthcheck';
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: HealthCheckResponse;  }>((resolve, reject) => {
